...
class MuseumThreeDimensionScreen extends StatefulWidget {
  ...
  @override
  State<MuseumThreeDimensionScreen> createState() => _MuseumThreeDimensionScreenState();
}

class _MuseumThreeDimensionScreenState extends State<MuseumThreeDimensionScreen> {
  @override
          ...
          ElevatedCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const WebViewContainer(url: "https://baotang.hochiminh.vn/"),
                )
              );
            },
          ),
          ElevatedCard(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const WebViewContainer(url: "https://demo-map.vietnaminfo.net/tours/bthcm/"),
                  )
              );
            },
          ),
          ElevatedCard(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const WebViewContainer(url: "https://demo.egal.vn/virtual-museum/baotanghcm2020/?utm_source=zalo&utm_medium=zalo&utm_campaign=zalo&zarsrc=30#%23"),
                  )
              );
            },
          ),
          ElevatedCard(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const WebViewContainer(url: "http://baotanghochiminh.baotangao.com/"),
                  )
              );
            },
          ),
