            ...
            builder: (context, snapshot) {
              if(snapshot.connectionState == ConnectionState.done) {
                if(snapshot.hasData) {
                  ...
                  final firstName = TextEditingController(text: userModel.firstName);
                  final lastName = TextEditingController(text: userModel.lastName);
                  final phoneNumber = TextEditingController(text: userModel.phoneNumber);
                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                label: Text('FirstName'), prefixIcon: Icon(Iconsax.user),
                              ),
                            ),
                            const SizedBox(height: 32),
                            TextFormField(
                              controller: lastName,
                              decoration: const InputDecoration(
                                label: Text('LastName'), prefixIcon: Icon(Iconsax.user),
                              ),
                            ),
                            const SizedBox(height: 32),
                            TextFormField(
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text('Cập nhật', style: TextStyle(color: TColors.black, fontSize: 18)),
                              ),
                            )
                          ],
                        ),
